...
{
    public class RayleighBenardAttractor : GH_Component
    {
        public RayleighBenardAttractor()
          : base("RayleighBenardAttractor", "AA",
            "Construct a RayleighBenardAttractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Alpha", "α", "Alpha", GH_ParamAccess.item, 9);
            pManager.AddNumberParameter("Beta", "β", "Beta", GH_ParamAccess.item, 5);
            pManager.AddNumberParameter("Gama", "γ", "Gama", GH_ParamAccess.item, 12);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> RayleighBenardAttractorPoints = GenerateRayleighBenardAttractor(StartPoint, Alpha, Beta, Gama, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)RayleighBenardAttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(RayleighBenardAttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateRayleighBenardAttractor(Point3d StartPoint, double Alpha, double Beta, double Gama, double DeltaT, int Iterations)
        {
            point = StartPoint;
            ...
            for (int i = 0; i < Iterations; i++)
            {
                ...
                newpoints.Add(point);
                double dx = -Alpha *x+Alpha*y;
                double dy = Gama * x + y - x * z;
        ...
        public override Guid ComponentGuid => new Guid("1F7E9A4C-3D8B-4A2C-9D6E-5B1A8C4F7E3D");
    }
}