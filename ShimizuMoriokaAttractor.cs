...
{
    public class ShimizuMoriokaAttractor : GH_Component
    {
        public ShimizuMoriokaAttractor()
          : base("ShimizuMoriokaAttractor", "AA",
            "Construct a ShimizuMoriokaAttractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Alpha", "α", "Alpha", GH_ParamAccess.item, 0.75);
            pManager.AddNumberParameter("Beta", "β", "Beta", GH_ParamAccess.item, 0.45);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> ShimizuMoriokaAttractorPoints = GenerateShimizuMoriokaAttractor(StartPoint, Alpha, Beta, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)ShimizuMoriokaAttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(ShimizuMoriokaAttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateShimizuMoriokaAttractor(Point3d StartPoint, double Alpha, double Beta, double DeltaT, int Iterations)
        {
            point = StartPoint;
            ...
            for (int i = 0; i < Iterations; i++)
            {
                ...
                newpoints.Add(point);
                double dx = y;
                double dy = (1-z)*x-Alpha*y;
                double dz = x*x-Beta*z;
        ...
        public override Guid ComponentGuid => new Guid("9F5A7C1D-3E8B-4A5C-9D2E-6B1A8C4F7E3D");
    }
}