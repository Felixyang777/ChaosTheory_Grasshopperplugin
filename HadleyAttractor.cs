...
{
    public class HadleyAttractor : GH_Component
    {
        public HadleyAttractor()
          : base("HadleyAttractor", "AA",
            "Construct a HadleyAttractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Zeta", "ζ", "Zeta", GH_ParamAccess.item, 8);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> HadleyAttractorPoints = GenerateHadleyAttractor(StartPoint, Alpha, Beta, Zeta, Delta, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)HadleyAttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(HadleyAttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateHadleyAttractor(Point3d StartPoint, double Alpha, double Beta, double Zeta, double Delta,  double DeltaT, int Iterations)
        {
            point = StartPoint;
            ...
            for (int i = 0; i < Iterations; i++)
            {
                ...
                newpoints.Add(point);
                double dx = -y*y-z*z-Alpha*x+Alpha*Zeta;
                double dy = x*y-Beta*x*z-y+Delta;
                double dz = Beta*x*y+x*z-z;
        ...
        public override Guid ComponentGuid => new Guid("2E7D9A4C-1F3B-4A8D-9C6E-5B3A7D1F4E8C");
    }
}