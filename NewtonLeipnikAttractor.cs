...
{
    public class NewtonLeipnikAttractor : GH_Component
    {
        public NewtonLeipnikAttractor()
          : base("NewtonLeipnikAttractor", "AA",
            "Construct a NewtonLeipnikAttractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Beta", "β", "Beta", GH_ParamAccess.item, 0.175);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> NewtonLeipnikAttractorPoints = GenerateNewtonLeipnikAttractor(StartPoint, Alpha, Beta, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)NewtonLeipnikAttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(NewtonLeipnikAttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateNewtonLeipnikAttractor(Point3d StartPoint, double Alpha, double Beta, double DeltaT, int Iterations)
        {
            point = StartPoint;
            ...
            for (int i = 0; i < Iterations; i++)
            {
                ...
                newpoints.Add(point);
                double dx = -Alpha *x+y+10*y*z;
                double dy = -x-0.4*y+5*x*z;
                double dz = Beta * z - 5*x * y;
        ...
        public override Guid ComponentGuid => new Guid("9E5A7C1D-3F8B-4A5C-9D2E-6B1A8C4F7E3D");
    }
}