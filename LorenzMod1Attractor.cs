...
{
    public class LorenzMod1Attractor : GH_Component
    {
        public LorenzMod1Attractor()
          : base("LorenzMod1Attractor", "AA",
            "Construct a LorenzMod1Attractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Alpha", "α", "Alpha", GH_ParamAccess.item, 0.1);
            pManager.AddNumberParameter("Beta", "β", "Beta", GH_ParamAccess.item, 4);
            pManager.AddNumberParameter("Zeta", "ζ", "Zeta", GH_ParamAccess.item, 14);
            pManager.AddNumberParameter("Delta", "δ", "Delta", GH_ParamAccess.item, 0.08);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> LorenzMod1AttractorPoints = GenerateLorenzMod1Attractor(StartPoint, Alpha, Beta, Zeta, Delta, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)LorenzMod1AttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(LorenzMod1AttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateLorenzMod1Attractor(Point3d StartPoint, double Alpha, double Beta, double Zeta, double Delta, double DeltaT, int Iterations)
        {
            point = StartPoint;
        ...
        public override Guid ComponentGuid => new Guid("1E7D9A4C-3F8B-4A2C-9D6E-5B1A8C4F7E3D");
    }
}