...
{
    public class SakaryaAttractor : GH_Component
    {
        public SakaryaAttractor()
          : base("SakaryaAttractor", "AA",
            "Construct a SakaryaAttractor.",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Alpha", "α", "Alpha", GH_ParamAccess.item, 0.4);
            pManager.AddNumberParameter("Beta", "β", "Beta", GH_ParamAccess.item, 0.3);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<Point3d> SakaryaAttractorPoints = GenerateSakaryaAttractor(StartPoint, Alpha, Beta, DeltaT, Iterations);
            IEnumerable __enum_points = (IEnumerable)SakaryaAttractorPoints;
            DA.SetDataList(0, __enum_points);

            var curve = Curve.CreateInterpolatedCurve(SakaryaAttractorPoints, 3);
            DA.SetData(1, curve);
        ...
        Point3d point;
        List<Point3d> GenerateSakaryaAttractor(Point3d StartPoint, double Alpha, double Beta, double DeltaT, int Iterations)
        {
            point = StartPoint;
            ...
            for (int i = 0; i < Iterations; i++)
            {
                ...
                newpoints.Add(point);
                double dx = -x+y+y*z;
                double dy = -x - y + Alpha*x*z;
                double dz = z-Beta*x*y;
        ...
        public override Guid ComponentGuid => new Guid("3E9A7D1C-4F8B-4A2C-9D6E-5B1A8C4F7E3D");
    }
}